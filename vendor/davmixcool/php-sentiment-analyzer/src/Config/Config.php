...
class Config
{
    ...
    const SPECIAL_CASE_IDIOMS = ["the shit"=> 3, "the bomb"=> 3, "bad ass"=> 1.5, "bus stop"=> 0.0, "yeah right"=> -2, "cut the mustard"=> 2, "kiss of death"=> -1.5, "hand to mouth"=> -2, "beating heart"=> 3.1,"broken heart"=> -2.9,  "to die for"=> 3, "putain"=> 3, "con"=> 3, "connard"=> 3, "salop"=> 3, "salope"=> 3, "batard"=> 3, "pute" => 3];
    ##Static methods##
