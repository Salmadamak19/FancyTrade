...
class PostController extends AbstractController
{
     ...
     */
    public function addPost(Request $request, PostRepository $postRepository, SluggerInterface $slugger, FlashyNotifier $flashy,TokenStorageInterface $tokenStorage): Response
    {
     ...
     */
    public function new(Request $request, PostRepository $postRepository, SluggerInterface $slugger,TokenStorageInterface $tokenStorage): Response
    {
        $user = $tokenStorage->getToken()->getUser();
        $post = new Post();
        $post->setDateP(new \DateTime());
