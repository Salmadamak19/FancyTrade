...
/**
     ...
     */ 
    public function new(Request $request, CommentaireRepository $commentaireRepository, PostRepository $rep,$id,TokenStorageInterface $tokenStorage): Response
    {
     ...
     */
    public function commentpost(Request $request, CommentaireRepository $commentaireRepository, PostRepository $rep, $id,TokenStorageInterface $tokenStorage): Response
    {
        $user = $tokenStorage->getToken()->getUser();
        $post= $rep->find($id);
        $commentaire = new Commentaire();
