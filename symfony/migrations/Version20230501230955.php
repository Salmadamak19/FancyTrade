 ...
 */
final class Version20230501230955 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD user_id INT DEFAULT NULL, DROP user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD user VARCHAR(255) DEFAULT NULL, DROP user_id');
    }
}
