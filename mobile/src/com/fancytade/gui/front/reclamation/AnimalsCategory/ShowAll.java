...
public class ShowAll extends Form {
    ...
    private Container makeModelWithoutButtons(ReclamationCategory AnimalsCategory) {
       ...
       AnimalsCategoryModel.setUIID("containerRounded");
        ...
        EspeceLabel = new Label("nom : " + AnimalsCategory.getNom());
        EspeceLabel.setUIID("labelDefault");


        AnimalsCategoryModel.addAll(
                
                EspeceLabel, RaceLabel
        );
    ...
    private Component makeAnimalsCategoryModel(ReclamationCategory AnimalsCategory) {
        ...
        btnAfficherScreenshot.addActionListener(listener -> share(AnimalsCategory));
    ...
    private void share(ReclamationCategory AnimalsCategory) {
        Form form = new Form(new BoxLayout(BoxLayout.Y_AXIS));
        form.add(makeModelWithoutButtons(AnimalsCategory));
        ...
        Form screenShotForm = new Form("Partager AnimalsCategory", new BoxLayout(BoxLayout.Y_AXIS));
        ...
        btnPartager.setTextToShare(AnimalsCategory.toString());
